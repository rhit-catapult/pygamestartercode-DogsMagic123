...
class Hero:
    ...
    def hit_by(self, raindrop):
        ...
        # DO 19: Return True if this Hero is currently colliding with the given Raindrop.

        hero_hit_box = pygame.Rect(self.x, self.y,self.image_no_umbrella.get_width(), self. image_umbrella.get_height())
